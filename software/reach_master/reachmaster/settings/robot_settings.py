...
class RobotSettings(tk.Toplevel):
    ...
    def __init__(self, parent):
        ...
        self.command_source.set(self.config['RobotSettings']['command_source'])
    ...
    def on_quit(self):      
        ...
        self.config['RobotSettings']['command_source'] = self.command_source.get()        
