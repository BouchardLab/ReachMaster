...
class ReachMaster:
    ...
    def _configure_window(self):
        ...
        self.exp_controller_menu = apply(
            tk.OptionMenu, 
            (self.window, self.exp_control_port) + tuple(self.port_list)
            )
        ...
        self.rob_controller_menu = apply(
            tk.OptionMenu, 
            (self.window, self.rob_control_port) + tuple(self.port_list)
            )
        ...
        self.protocol_menu = apply(
            tk.OptionMenu, 
            (self.window, self.protocol) + tuple(self.protocol_list)
            )
