...
^^^^^^^^^^^^^^^^^^^^^^^^^^
.. automodule:: software.controller_scripts.experiment_controller.experiment_controller
    :members:
Robot Controller Arduino Code
^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.. automodule:: software.controller_scripts.robot_controller.robot_controller
    :members:
